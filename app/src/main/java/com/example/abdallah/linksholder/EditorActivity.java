...
public class EditorActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        urlEditText = (EditText) findViewById(R.id.url_id);


        if (mCurrentUri == null) {
            setTitle("New URL");
            invalidateOptionsMenu();
            String clipboard = readFromClipboard();
            urlEditText.setText(clipboard);
    ...
    private void save() {
        ...
        if (mCurrentUri == null &&
                TextUtils.isEmpty(nameString) && TextUtils.isEmpty(urlString)) {
            return;
        }

        ContentValues values = new ContentValues();
        values.put(Contract.DataEntry.COLUMN_NAME, nameString);
        values.put(Contract.DataEntry.COLUMN_URL, urlString);
        ...
        if (mCurrentUri == null) {
            ...
            if (newUri == null) {
                ...
                Toast.makeText(this, "Error with saving Url",
                        Toast.LENGTH_SHORT).show();
            } else {
                // Otherwise, the insertion was successful and we can display a toast.
                Toast.makeText(this, "Url saved",
                        Toast.LENGTH_SHORT).show();
            }
        } else {
            ...
            if (rowsAffected == 0) {
                ...
                Toast.makeText(this, "Error with updating url",
                        Toast.LENGTH_SHORT).show();
            } else {
                // Otherwise, the update was successful and we can display a toast.
                Toast.makeText(this, "Url updated",
                        Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void showUnsavedChangesDialog(
        ...
        builder.setMessage("Do you want to unsaved changes ?");
